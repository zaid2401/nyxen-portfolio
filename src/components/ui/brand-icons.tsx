 ...
 * Brand marks.
 *
 * lucide-react dropped brand icons in v1, so the two this site needs live here
 * as the official marks, used nominatively to link to profiles on those
 * services. They take the same props as a lucide icon (`className`,
 * `aria-hidden`), so call sites are identical.
 */
